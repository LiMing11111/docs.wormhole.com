...
Each Chain ID is documented on its page in the [Blockchain Environments](../blockchain-environments/).
...
The [Gateway](../tan-suo-chong-dong-wormhole/gateway/) is Cosmos-SDK chain used by Wormhole to facilitate communication with the Cosmos ecosystem.

## Guardian

A [Guardian](../tan-suo-chong-dong-wormhole/guardian.md) is one of the 19 parties running validators in the Guardian Network that contributes to the VAA multisig.
...
[Verifiable Action Approvals](../tan-suo-chong-dong-wormhole/vaa.md) (VAAs) are the base data structure in the Wormhole ecosystem, containing the messages emitted by xDapps along with information such as what contract emitted the message.
